...
mesh = TreeMesh(coordinates_min, coordinates_max, initial_refinement_level=7, n_cells_max=10_000)
...
plot(pd["rho"], ylims = (0.8,3.5), xguide="x", yguide="y")
#plot(pd["vx"], ylims = (-1.0,1.0), xguide="x", yguide="y")
#plot(pd["theta"], ylims = (0.5,1.5), xguide="x", yguide="y")
#plot(pd)
