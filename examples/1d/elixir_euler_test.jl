...
sol = solve(ode, CarpenterKennedy2N54(williamson_condition=false),dt=1.0, save_everystep=false, callback=callbacks, maxiters=1e5);
summary_callback() # print the timer summary
               
pd = PlotData1D(sol)
plot(pd)
#plot(pd["rho"], ylims = (0.0,0.5), xguide="x", yguide="y")