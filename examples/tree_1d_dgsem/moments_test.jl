...
plot(pde.x, pde.data[:,1] , size = (800,500), label =  "KG Flux", titlefontsize = 21, tickfontsize=12, linewidth = 4)
...
# plot!(pd.x, pd.data[:,1] , size = (800,500), label =  "KG Flux", titlefontsize = 21, tickfontsize=12, linewidth = 4)
