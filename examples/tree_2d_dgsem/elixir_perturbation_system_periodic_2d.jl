...
coordinates_min = (-30.0, -30.0)
coordinates_max = ( 30.0, 30.0)
...
#rho plot
plot(pd2.x, pd2.data[:,1], xlims = (-30.0, 55.0), label = "DGSEM ad. ZV 2D", title ="rho, t = "*string(t)*", tau = "*string(tau), markersize=3, seriestype = :scatter)
...
plot!(pd.x, pd.data[:,1], label = "DGSEM ad. ZV 1D", seriestype = :scatter, markersize=3)
savefig("periodisch.png")
