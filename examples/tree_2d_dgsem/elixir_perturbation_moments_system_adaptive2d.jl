...
# #rho plot
plot(pd.x, pd.data[:,1], xlims = (-1.0, 1.0), label = "DGSEM ad. ZV 2D", title ="rho, t = "*string(t)*", tau = "*string(tau), markersize=3)

# #plot!(pd.x, rho1d, label = "DGSEM ad. ZV 1D", markersize=4)
# savefig("rho.png")

# plot(pd.x, pd.data[:,2], xlims = (-1.0, 1.0), label = "DGSEM ad. ZV 2D", title ="vx, t = "*string(t)*", tau = "*string(tau), seriestype = :scatter, markersize=3)
# #plot!(pd.x, vx1d, label = "DGSEM ad. ZV 1D", markersize=4)
# savefig("vx.png")


# plot(pd.x, pd.data[:,4], xlims = (-1.0, 1.0), label = "DGSEM ad. ZV 2D", title ="theta, t = "*string(t)*", tau = "*string(tau), seriestype = :scatter, markersize=3)
# #plot!(pd.x, theta1d, label = "DGSEM ad. ZV 1D", markersize=4)
# savefig("theta.png")
