@muladd begin
    ...
    """
    struct EulerEquations2D{RealT<:Real} <: AbstractCompressibleEulerEquations{2, 4}
      gamma::RealT               # ratio of specific heats
      inv_gamma_minus_one::RealT # = inv(gamma - 1); can be used to write slow divisions as fast multiplications
    
      function EulerEquations2D(gamma)
    ...
    """
        initial_condition_constant(x, t, equations::EulerEquations2D)
    ...
    """
        initial_condition_convergence_test(x, t, equations::EulerEquations2D)
    
    A smooth initial condition used for convergence tests in combination with
    [`source_terms_convergence_test`](@ref)
    (and [`BoundaryConditionDirichlet(initial_condition_convergence_test)`](@ref) in non-periodic domains).
    """
    function initial_condition_convergence_test(x, t, equations::EulerEquations2D)
      c = 2
      A = 0.1
      L = 2
      f = 1/L
    ...
    """
        source_terms_convergence_test(u, x, t, equations::EulerEquations2D)
    
    Source terms used for convergence tests in combination with
    [`initial_condition_convergence_test`](@ref)
    (and [`BoundaryConditionDirichlet(initial_condition_convergence_test)`](@ref) in non-periodic domains).
    """
    @inline function source_terms_convergence_test(u, x, t, equations::EulerEquations2D)
      ...
      # du1 = 0
      # du2 = (2*ω*cos((x2+x1-t)*ω)*sin((x2+x1-t)*ω)+35*ω*cos((x2+x1-t)*ω))/150
    ...
    """
        initial_condition_density_wave(x, t, equations::EulerEquations2D)
    ...
    - polydeg = 5
    """
    function initial_condition_density_wave(x, t, equations::EulerEquations2D)
      v1 = 0.1
      v2 = 0.2
    ...
    """
        initial_condition_weak_blast_wave(x, t, equations::EulerEquations2D)
    ...
    """
    function initial_condition_weak_blast_wave(x, t, equations::EulerEquations2D)
    ...
    """
        initial_condition_eoc_test_coupled_euler_gravity(x, t, equations::EulerEquations2D)
    ...
    """
    function initial_condition_eoc_test_coupled_euler_gravity(x, t, equations::EulerEquations2D)
    ...
    """
        source_terms_eoc_test_coupled_euler_gravity(u, x, t, equations::EulerEquations2D)
    ...
    """
    @inline function source_terms_eoc_test_coupled_euler_gravity(u, x, t, equations::EulerEquations2D)
    ...
    """
        source_terms_eoc_test_euler(u, x, t, equations::EulerEquations2D)
    ...
    in combination with [`initial_condition_eoc_test_coupled_euler_gravity`](@ref).
    """
    @inline function source_terms_eoc_test_euler(u, x, t, equations::EulerEquations2D)
      # Same settings as in `initial_condition_eoc_test_coupled_euler_gravity`
      c = 2.0
      A = 0.1
      G = 1.0
    ...
    function boundary_condition_slip_wall(u_inner, normal_direction::AbstractVector, x, t,
                                          surface_flux_function, equations::EulerEquations2D)
    ...
    @inline function flux(u, orientation::Integer, equations::EulerEquations2D)
    ...
    @inline function flux(u, normal_direction::AbstractVector, equations::EulerEquations2D)
      rho_e = last(u)
      rho, v1, v2, t = cons2prim(u, equations)
      p = rho*t
    ...
    """
    @inline function flux_shima_etal(u_ll, u_rr, orientation::Integer, equations::EulerEquations2D)
    ...
    @inline function flux_shima_etal(u_ll, u_rr, normal_direction::AbstractVector, equations::EulerEquations2D)
      # Unpack left and right state
      rho_ll, v1_ll, v2_ll, p_ll = cons2prim(u_ll, equations)
      rho_rr, v1_rr, v2_rr, p_rr = cons2prim(u_rr, equations)
    ...
    """
    @inline function flux_kennedy_gruber(u_ll, u_rr, orientation::Integer, equations::EulerEquations2D)
      # Unpack left and right state
      rho_e_ll = last(u_ll)
      rho_e_rr = last(u_rr)
      rho_ll, v1_ll, v2_ll, p_ll = cons2prim(u_ll, equations)
    ...
    @inline function flux_kennedy_gruber(u_ll, u_rr, normal_direction::AbstractVector, equations::EulerEquations2D)
      # Unpack left and right state
      rho_e_ll = last(u_ll)
      rho_e_rr = last(u_rr)
      rho_ll, v1_ll, v2_ll, p_ll = cons2prim(u_ll, equations)
    ...
    """
        flux_chandrashekar(u_ll, u_rr, orientation, equations::EulerEquations2D)
    ...
    """
    @inline function flux_chandrashekar(u_ll, u_rr, orientation::Integer, equations::EulerEquations2D)
      # Unpack left and right state
      rho_ll, v1_ll, v2_ll, p_ll = cons2prim(u_ll, equations)
      rho_rr, v1_rr, v2_rr, p_rr = cons2prim(u_rr, equations)
    ...
    """
    @inline function flux_ranocha(u_ll, u_rr, orientation::Integer, equations::EulerEquations2D)
      # Unpack left and right state
      rho_ll, v1_ll, v2_ll, p_ll = cons2prim(u_ll, equations)
      rho_rr, v1_rr, v2_rr, p_rr = cons2prim(u_rr, equations)
    ...
    @inline function flux_ranocha(u_ll, u_rr, normal_direction::AbstractVector, equations::EulerEquations2D)
      # Unpack left and right state
      rho_ll, v1_ll, v2_ll, p_ll = cons2prim(u_ll, equations)
      rho_rr, v1_rr, v2_rr, p_rr = cons2prim(u_rr, equations)
      v_dot_n_ll = v1_ll * normal_direction[1] + v2_ll * normal_direction[2]
    ...
    @inline function max_abs_speed_naive(u_ll, u_rr, orientation::Integer, equations::EulerEquations2D)
      rho_ll, v1_ll, v2_ll, p_ll = cons2prim(u_ll, equations)
      rho_rr, v1_rr, v2_rr, p_rr = cons2prim(u_rr, equations)
    ...
    @inline function max_abs_speed_naive(u_ll, u_rr, normal_direction::AbstractVector, equations::EulerEquations2D)
      rho_ll, v1_ll, v2_ll, p_ll = cons2prim(u_ll, equations)
      rho_rr, v1_rr, v2_rr, p_rr = cons2prim(u_rr, equations)
    ...
    @inline function rotate_to_x(u, normal_vector, equations::EulerEquations2D)
    ...
    @inline function rotate_from_x(u, normal_vector, equations::EulerEquations2D)
      # cos and sin of the angle between the x-axis and the normalized normal_vector are
      # the normalized vector's x and y coordinates respectively (see unit circle).
      c = normal_vector[1]
      s = normal_vector[2]
     ...
     """
        flux_hllc(u_ll, u_rr, orientation, equations::EulerEquations2D)
    ...
    """
    function flux_hllc(u_ll, u_rr, orientation::Integer, equations::EulerEquations2D)
    ...
    @inline function max_abs_speeds(u, equations::EulerEquations2D)
    ...
    @inline function cons2prim(u, equations::EulerEquations2D)
      rho, rho_v1, rho_v2, rho_e = u
    ...
    @inline function cons2entropy(u, equations::EulerEquations2D)
      rho, rho_v1, rho_v2, rho_e = u
    ...
    @inline function entropy2cons(w, equations::EulerEquations2D)
    ...
    @inline function prim2cons(prim, equations::EulerEquations2D)
      rho, v1, v2, p = prim
      rho_v1 = rho * v1
      rho_v2 = rho * v2
    ...
    @inline function density(u, equations::EulerEquations2D)
     rho = u[1]
     return rho
    end
    
    
    @inline function pressure(u, equations::EulerEquations2D)
     rho, rho_v1, rho_v2, rho_e = u
    ...
    @inline function density_pressure(u, equations::EulerEquations2D)
     rho, rho_v1, rho_v2, rho_e = u
    ...
    @inline function entropy_thermodynamic(cons, equations::EulerEquations2D)
      # Pressure
    ...
    @inline function entropy_math(cons, equations::EulerEquations2D)
      # Mathematical entropy
    ...
    @inline entropy(cons, equations::EulerEquations2D) = entropy_math(cons, equations)
    
    
    # Calculate total energy for a conservative state `cons`
    @inline energy_total(cons, ::EulerEquations2D) = cons[4]
    
    
    # Calculate kinetic energy for a conservative state `cons`
    @inline function energy_kinetic(u, equations::EulerEquations2D)
      rho, rho_v1, rho_v2, rho_e = u
    ...
    @inline function energy_internal(cons, equations::EulerEquations2D)
