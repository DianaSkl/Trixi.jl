...
function initial_condition_constant(x, t, equations::PerturbationMomentSystem2D)
  ...
  return SVector(init_w0(equations::PerturbationMomentSystem2D), 
                 init_w0x(equations::PerturbationMomentSystem2D), 
                 init_w0y(equations::PerturbationMomentSystem2D), 
                 init_w1(equations::PerturbationMomentSystem2D),
                 init_w0xx(equations::PerturbationMomentSystem2D),
                 init_w0yy(equations::PerturbationMomentSystem2D),
                 init_w0xy(equations::PerturbationMomentSystem2D), 
                 init_w1x(equations::PerturbationMomentSystem2D),
                 init_w1y(equations::PerturbationMomentSystem2D))
end


@inline function init_w0(equations::PerturbationMomentSystem2D)
...
@inline function init_w0x(equations::PerturbationMomentSystem2D)
...
@inline function init_w0y(equations::PerturbationMomentSystem2D)
...
@inline function init_w1(equations::PerturbationMomentSystem2D)
...
@inline function init_w0xx(equations::PerturbationMomentSystem2D)
...
@inline function init_w0yy(equations::PerturbationMomentSystem2D)
...
@inline function init_w0xy(equations::PerturbationMomentSystem2D)
...
@inline function init_w1x(equations::PerturbationMomentSystem2D)
...
@inline function init_w1y(equations::PerturbationMomentSystem2D)
