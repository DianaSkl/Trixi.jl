...
@inline function max_abs_speeds_naive(u, equations::PerturbationMomentSystem2D)
    return SVector(2.0, 2.0)
end
...
@inline function source_terms_convergence_test(u, x, t, equations::PerturbationMomentSystem2D)
  ...
  du2 = -w0 * w0xy + w0x * woy/ 4.0 + w0x * w0x/ 4.0
  ...
  return SVector(du1/tau, du2/tau, du3/tau, du4/tau, du5/tau)
end
