struct PerturbationPrimMomentSystem1D{RealT<:Real} <: AbstractPerturbationMomentSystem{1, 9} 
    vxr::RealT
    theta_r::RealT
    rho_r::RealT
    tau::RealT
  ...
  varnames(::typeof(cons2cons), ::PerturbationPrimMomentSystem1D) = ("rho", "v_x", "v_y", "theta", "sigm_xx", "sigma_xy", "sigma_yy", "q_x", "q_y")
  varnames(::typeof(cons2prim), ::PerturbationPrimMomentSystem1D) = ("w0", "w0x", "w0y", "w1", "w0xx", "w0yy", "w0xy", "w1x", "w1y")
  
  @inline function flux(u, orientation::Integer, equations::PerturbationPrimMomentSystem1D)
    w0, w0x, w0y, w1, w0xx, w0yy, w0xy, w1x, w1y = cons2prim(u, equations)
  ...
  @inline function prim2cons(u, equations::PerturbationPrimMomentSystem1D)
    ...
    return SVector( rho, v_x, v_y, theta, sigma_xx, sigma_xy, sigma_yy, q_x, q_y)
  end
    
  @inline function cons2prim(u, equations::PerturbationPrimMomentSystem1D)
    rho, v_x, v_y, theta, sigma_xx, sigma_xy, sigma_yy, q_x, q_y = u 
    @unpack vxr, theta_r, rho_r  = equations
  ...
  @inline function cons2entropy(u, equations::PerturbationPrimMomentSystem1D)
    rho, v_x, v_y, theta, sigma_xx, sigma_xy, sigma_yy, q_x, q_y = u 
  
    return SVector(rho, v_x, v_y, theta, sigma_xx, sigma_xy, sigma_yy, q_x, q_y)
  end
  
  @inline function max_abs_speed_naive(u_ll, u_rr, orientation::Integer, equations::PerturbationPrimMomentSystem1D)
  ...
  @inline function max_abs_speeds(u, equations::PerturbationPrimMomentSystem1D)
    @unpack vxr, theta_r = equations
    ab1 = abs(vxr) + 2.0 * sqrt(5 * theta_r / 3)
  ...
  function initial_condition_convergence_test(x, t, equations::PerturbationPrimMomentSystem1D)
  ...
  # @inline function source_terms_convergence_test(u, x, t, equations::PerturbationPrimMomentSystem1D)
  #   w0, w0x, w0y, w1, w0xx, w0yy, w0xy, w1x, w1y = u
  ...
  @inline function source_terms_convergence_test(u, x, t, equations::PerturbationPrimMomentSystem1D)
    ...
    w0, w0x, w0y, w1, w0xx, w0yy, w0xy, w1x, w1y  = prim2cons(u, equations)
  ...
  function shocktube(x, equations::PerturbationPrimMomentSystem1D)
    rho_r = 1
    if (x[1] < 0)
      drho = 3 - rho_r
    else
  ...
  function initial_condition_constant(x, t, equations::PerturbationPrimMomentSystem1D)
  
    return SVector(init_w0(x, t, equations::PerturbationPrimMomentSystem1D), 
                   init_w0x(x, t, equations::PerturbationPrimMomentSystem1D), 
                   init_w0y(x, t, equations::PerturbationPrimMomentSystem1D), 
                   init_w1(x, t, equations::PerturbationPrimMomentSystem1D),
                   init_w0xx(x, t, equations::PerturbationPrimMomentSystem1D),
                   init_w0yy(x, t, equations::PerturbationPrimMomentSystem1D),
                   init_w0xy(x, t, equations::PerturbationPrimMomentSystem1D), 
                   init_w1x(x, t, equations::PerturbationPrimMomentSystem1D),
                   init_w1y(x, t, equations::PerturbationPrimMomentSystem1D))
  end
  
  
  @inline function init_w0(x, t, equations::PerturbationPrimMomentSystem1D)
  ...
  @inline function init_w0x(x, t, equations::PerturbationPrimMomentSystem1D)
  ...
  @inline function init_w0y(x, t, equations::PerturbationPrimMomentSystem1D)
  ...
  @inline function init_w1(x, t, equations::PerturbationPrimMomentSystem1D)
  ...
  @inline function init_w0xx(x, t, equations::PerturbationPrimMomentSystem1D)
  ...
  @inline function init_w0yy(x, t, equations::PerturbationPrimMomentSystem1D)
  ...
  @inline function init_w0xy(x, t, equations::PerturbationPrimMomentSystem1D)
  ...
  @inline function init_w1x(x, t, equations::PerturbationPrimMomentSystem1D)
  ...
  @inline function init_w1y(x, t, equations::PerturbationPrimMomentSystem1D)
