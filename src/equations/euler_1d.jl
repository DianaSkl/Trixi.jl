...
@muladd begin
    ...
    """
        flux_ranocha(u_ll, u_rr, orientation_or_normal_direction, equations::EulerEquations1D)
    ...
    @inline function flux_ranocha(u_ll, u_rr, normal_direction::AbstractVector, equations::EulerEquations1D)
